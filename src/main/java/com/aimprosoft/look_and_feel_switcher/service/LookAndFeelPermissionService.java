 ...
 */
@Service
public class LookAndFeelPermissionService {

    private final static String RESOURCE_NAME = LookAndFeel.class.getName();
    private final static int SCOPE = ResourceConstants.SCOPE_COMPANY;
    ...
    public void addAllPermissions(LookAndFeel lookAndFeel) throws ApplicationException {
        List<Action> allActions = getLookAndFeelActions();
        for (Action action : allActions) {
